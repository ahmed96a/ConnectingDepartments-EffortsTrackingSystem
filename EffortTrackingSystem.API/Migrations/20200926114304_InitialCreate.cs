        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expected_Deadline = table.Column<DateTime>(nullable: false),
                    Task_CompleteDate = table.Column<DateTime>(nullable: false),
                    ...
                    Category_Id = table.Column<short>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Missions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Missions_Categories_Category_Id",
                        column: x => x.Category_Id,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Missions_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Missions_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Missions_Category_Id",
                table: "Missions",
                column: "Category_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Missions_ReceiverId",
                table: "Missions",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_Missions_SenderId",
                table: "Missions",
                column: "SenderId");
        }
